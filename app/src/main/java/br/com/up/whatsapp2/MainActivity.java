            ...
            public void onClick(View v) {
                ...
                if (!messagestr.isEmpty() && !phonestr.isEmpty()) {
                    ...
                    if (isWhatappInstalled()){
                        ...
                        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://wa.me/"+phonestr+
                                "/?text="+messagestr));
                        startActivity(i);
                        message.setText("");
                        phone.setText("");
                        ...
                        Toast.makeText(MainActivity.this,"Whatsapp2 não está instalado!",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity.this, "Informe o número e a mensagem a ser enviada!", Toast.LENGTH_LONG).show();
